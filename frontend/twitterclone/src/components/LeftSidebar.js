        ...
        <div className="w-[291px] p-3 fixed left-0 top-0 h-full flex flex-col justify-between border-r border-gray-200 items-center">
            <div >
                ...
                <div className="space-y-2 mt-4">
                    <Link to="/" className="flex items-center space-x-3 px-3 py-2 rounded-full hover:bg-gray-200">
                        <CiHome size="24px" />
                    ...
                    <Link to="/profile" className="flex items-center space-x-3 px-3 py-2 rounded-full hover:bg-gray-200">
                        <CiUser size="24px" />
                        <span className="font-medium text-sm">Cá nhân</span>
                    </Link>

                    <Link to="/login" className="flex items-center space-x-3 px-3 py-2 rounded-3 hover:bg-gray-200">
                        <CiLogout size="24px" />
